...
namespace Task1.Classes
{
    public class SweetsFactory
    {
        ...
        public ISweets CreateChocolateCandy(string name, double weight, double sugar, string form, double cacaocount,
            double cost)
        {
        ...
        public ISweets CreateLollipopCandy(string name, double weight, double sugar, string form, string color,
            double cost)
        {
            return new LollipopCandy(name, weight, sugar, form, color, cost);
        }

        public ISweets CreateMilkCandy(string name, double weight, double sugar, string form, double milkcount,
            double cost)
        {
